...
public abstract class Tablero {
	...
	public void setOrigenPacman(Casillero origenPacman, Juego juego) {
		this.origenPacman = origenPacman;
		if(juego.getPacman()!=null)
		juego.getPacman().reubicar();
	}
	...
	public void setOrigenFantasmas(Casillero origenFantasmas, Juego juego) {
		this.origenFantasmas = origenFantasmas;
		if(juego.getBlinky()!=null)
		juego.getBlinky().reubicar();
		//faltan los demas fantasmas!!
	}
